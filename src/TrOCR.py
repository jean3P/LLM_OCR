...
from utils.constants import outputs_path, model_save_path_seq_v2, processor_save_path_seq_v2, \
    model_save_path_seq_v2_mixed_20_80, processor_save_path_seq_v2_mixed_20_80, model_save_path_seq_v2_25, \
    processor_save_path_seq_v2_25, model_save_path_seq_v2_25_75, processor_save_path_seq_v2_25_75, \
    model_save_path_seq_v2_50, processor_save_path_seq_v2_50, model_save_path_seq_v2_50_50, \
    processor_save_path_seq_v2_50_50, model_save_path_seq_v2_75, processor_save_path_seq_v2_75, \
    processor_save_path_seq_v2_75_25, model_save_path_seq_v2_75_25, model_save_path_seq_v2_100, \
    processor_save_path_seq_v2_100
#
# device = torch.device('cuda:0' if torch.cuda.is_available else 'cpu')
#
# training = load_from_json(os.path.join(outputs_path, 'train', 'training_seq_data.json'))
# # training = load_from_json(os.path.join(outputs_path, 'mixed', 'train', 'mixed_train_seq_20_80.json'))
# # training = load_from_json(os.path.join(outputs_path, 'mixed', 'train', 'mixed_train_seq_50_50.json'))
# # training = load_from_json(os.path.join(outputs_path, 'mixed', 'train', 'mixed_train_seq_75_25.json'))
# valid = load_from_json(os.path.join(outputs_path, 'valid', 'validation_seq_data.json'))
#
# handler = DataFrameHandler()
#
# # Convert the training data dictionary to a DataFrame
# train_df = handler.dict_to_dataframe(training)
#
# # Sample 20% of the DataFrame
# sampled_train_df = handler.sample_dataframe(train_df, 100).reset_index(drop=True)
#
...
# os.makedirs(model_save_path_seq_v2_100, exist_ok=True)
# os.makedirs(processor_save_path_seq_v2_100, exist_ok=True)
#
# # Save the model
# model.save_pretrained(model_save_path_seq_v2_100)
#
# # Save the processor
# processor.save_pretrained(processor_save_path_seq_v2_100)
#
# print(f"Model saved to {model_save_path_seq_v2_100}")
# print(f"Processor saved to {processor_save_path_seq_v2_100}")
