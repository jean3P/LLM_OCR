...
def calculate_stats(data):
    ...
    for entry in data:
        ...
        if entry["Prompt checking: Grammar checking"]["response"] == "Yes":
            yes_count += 1
        elif entry["Prompt checking: Grammar checking"]["response"] == "No":
            no_count += 1
...
# json_file_path = os.path.join(outputs_path, 'base_line_with_check_and_correct_ocr_v2', 'automated_results',
#                               'final_test_evaluation_from_mistral_100.json')
# json_file_path = os.path.join(outputs_path, 'base_line_with_check_and_correct_ocr_v5', 'automated_results',
#                               'final_test_evaluation_from_mistral_25.json')
json_file_path = os.path.join(automated_resuts, 'final_test_evaluation_from_mistral_100.json')
# Load the data
