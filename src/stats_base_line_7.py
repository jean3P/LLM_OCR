...
def calculate_stats(data):
    ...
    for entry in data:
        ...
        total_confidence += int(entry["Prompt correcting"]["confidence"])
    ...
    mean_confidence = round((total_confidence / total_entries), 3)  # already in percentage
...
# json_file_path = os.path.join(outputs_path, 'evaluations_base_line_11_v3', 'automated_results', 'final_test_evaluation_from_mistral_100.json')
